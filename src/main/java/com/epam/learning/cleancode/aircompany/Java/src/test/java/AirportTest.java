package com.epam.learning.cleancode.aircompany.Java.src.test.java;

import com.epam.learning.cleancode.aircompany.Java.src.main.java.Airport;
import com.epam.learning.cleancode.aircompany.Java.src.main.java.models.ClassificationLevel;
import com.epam.learning.cleancode.aircompany.Java.src.main.java.models.ExperimentalTypes;
...
public class AirportTest {
    private static final List<Plane> planes = Arrays.asList(
            ...
            new MilitaryPlane(
                    "B-1B Lancer",
                    1050, 21000, 80000, MilitaryType.BOMBER),
            new MilitaryPlane(
                    "B-2 Spirit",
                    1030, 22000, 70000, MilitaryType.BOMBER),
            new MilitaryPlane(
                    "B-52 Stratofortress",
                    1000, 20000, 80000, MilitaryType.BOMBER),
            new MilitaryPlane(
                    "F-15",
                    1500, 12000, 10000, MilitaryType.FIGHTER),
            new MilitaryPlane(
                    "F-22",
                    1550, 13000, 11000, MilitaryType.FIGHTER),
            new MilitaryPlane(
                    "C-130 Hercules",
                    650, 5000, 110000, MilitaryType.TRANSPORT),
            new ExperimentalPlane(
                    "Bell X-14",
                    277, 482, 500, ExperimentalTypes.HIGH_ALTITUDE, ClassificationLevel.SECRET),
            new ExperimentalPlane(
                    "Ryan X-13 Vertijet",
                    560, 307, 500, ExperimentalTypes.VTOL, ClassificationLevel.TOP_SECRET)
    );
