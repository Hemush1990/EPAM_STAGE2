...
public class Actions extends Student{
    private List<Student> actions = new ArrayList<>();

    public Actions(int id, String surname, String name, String patronymic, String birthdate, String address, String faculty, String phoneNumber, String course, String group) {
