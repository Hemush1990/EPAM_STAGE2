...
public class AirportTest {
    ...
    @AfterTest
    public boolean testGetTransportMilitaryPlanes() {
        Airport airport = new Airport(planes);
        List<MilitaryPlane> transportMilitaryPlanes = airport.getMilitaryPlanes();
        boolean flag = false;
    ...
    public void testGetPassengerPlaneWithMaxCapacity() {
        ...
        Assert.assertTrue(expectedPlaneWithMaxPassengersCapacity.equals(planeWithMaxPassengerCapacity),
                "Should equal plane cabacity and expacted max capacity");
    }
    ...
    public void testSortMaxLoadCapacity() {
        ...
        assert (nextPlaneMaxLoadCapacityIsHigherThanCurrent);
    }
    ...
    @Test
    public boolean testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        Airport airport = new Airport(planes);
